return {
  ...
  config = function()
    ...
    vim.keymap.set('n', '<leader>fw', function() local word = vim.fn.expand("<cword>") builtin.grep_string({ search = word }) end)
    vim.keymap.set('n', '<leader>F', function() local word = vim.fn.expand("<cWORD>") builtin.grep_string({ search = word }) end)
    ...
    vim.keymap.set('n', '<leader>eh', function() builtin.find_files({ hidden = true }) end, { desc = "find hidden files" })
    vim.keymap.set('n', '<leader>el', function() builtin.live_grep() end, { desc = "live grep" })
    vim.keymap.set('n', '<leader>er', function() builtin.grep_string({ search = vim.fn.input("Grep > ") }) end, { desc = "grep string" })
