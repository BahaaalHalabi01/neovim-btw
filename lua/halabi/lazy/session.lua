return {
  ...
  config = function()
    ...
    require('session_manager').setup({
      ...
      autoload_mode = 'LastSession',                            -- Define what to do when Neovim is started without arguments. Possible values: Disabled, CurrentDir, LastSession
      ...
      autosave_ignore_buftypes = {'json'}, -- All buffers of these bufer types will be closed before the session is saved.
